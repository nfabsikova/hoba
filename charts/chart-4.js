export function makeChart4(mc, ba, danube, danubeLine) {
  ...
  //Footnote
  let footnote = "Zastúpenie žien vo veku 65+, Zdroj: ŠÚ SR";
  ...
  d3.select("#chart4").append("div").attr("id", "chart4_container");

  //Create map svg
  d3.select("#chart4_container").append("div").attr("id", "chart4_map").style("width", "300px").style("float", "left");

  let map = d3.select("#chart4_map")
    .append("svg")
    .attr("class", "map")
    .attr("width", mapWidth)
  ...
  //Create chart svg
  d3.select("#chart4_container").append("div").attr("id", "chart4_chart").style("width", "500px").style("float", "left").style("margin-bottom", "40px");

  let chart = d3.select("#chart4_chart")
      .append("g")
      .attr("class", "chart")

  //Create footnote
  d3.select("#chart4").append("p").text("a").style("color", "white").style("font-size", "2px");
  d3.select("#chart4").append("hr")
  d3.select("#chart4").append("p").attr("class", "footnote").text(footnote)
